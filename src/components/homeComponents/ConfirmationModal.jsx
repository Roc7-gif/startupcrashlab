...
export default function ConfirmationModal({
  ...
  const handleConfirm = () => {
    // Hook pour brancher ton API / onConfirm plus tard
      ...
      >
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-300 mb-5">{pack?.objective}</p>
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="bg-gray-800 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-lg bg-gray-700 text-white border border-gray-600 focus:outline-none focus:border-orange-500"
                    />
                  </div>
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      onChange={updateForm("reservationDate")}
                      className="w-full px-3 py-2 rounded-lg bg-gray-700 text-white border border-gray-600 focus:outline-none focus:border-orange-500"
                    />
                  </div>
                </div>
                ...
                <p className="text-xs text-gray-400 mt-3">
                  Vous recevrez un email de confirmation avec les détails du
                  programme et la procédure à suivre.
                </p>
              </div>
            </div>
