  ...
  return (
    <>
      <section className="bg-white hero-grid min-h-screen relative overflow-hidden">
        ...
        <nav className="flex flex-col md:flex-row items-center justify-between px-4 md:px-10 py-5 relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between px-4 md:px-10 pt-10 pb-20 max-w-7xl mx-auto relative z-10 gap-12">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight mb-1 fade-in-up">
              Ne lancez pas votre
              <br />
              startup à l'aveugle.
            </h1>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-orange-500 leading-tight mb-5 fade-in-up delay-200">
              Crashez-la.
            </h2>
